...
+ マルチステップチュートリアル {#multi}
   ...
   + [OpenAPI APIを使用したAEM コンテンツフラグメント配信の概要](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/getting-started-with-aem-headless/open-api/basic/overview){target=_blank}
   ...
   + [AEM APIの概要](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/aem-apis/overview){target=_blank}
