...
+ 開発{#developing}
   + 拡張機能{#extensibility}
      + App Builder{#app-builder}
         ...
         + [Github Webhook の検証](./developing/extensibility/app-builder/github-webhook-verification.md)
      + UI 拡張機能{#ui}
...
+ パーソナライゼーション {#personalization}
   ...
   + [ライブデモ](./personalization/live-demo.md)
   + 設定{#setup}
...
+ AEM API{#aem-apis}
   ...
   + OpenAPI{#openapis}
      ...
      + [ユーザー認証（SPA）](./apis/openapis/use-cases/invoke-api-using-oauth-single-page-app.md)
      + 方法{#how-to}
...
+ エキスパートリソース {#expert-resources}
   ...
   + Cloud 5{#cloud-5}
      ...
      + シーズン 4{#season-4}
         ...
         + [最適化を検索](./expert-resources/cloud-5/season-4/cloud5-search-optimization.md)
