...
>[!TIP]
>
> ライブデモを最初に調べることで、セットアップと実装に時間を費やす前に、各パーソナライゼーション手法の価値と機能を理解するのに役立ちます。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./live-demo.md" title="Personalization ユースケースのライブデモ" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/live-demo/live-demo.png" alt="Personalization ユースケースのライブデモ"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./live-demo.md" target="_self" rel="referrer" title="Personalization ユースケースのライブデモ">Personalization ユースケースのライブデモ </a>
                    </p>
                    <p class="is-size-6">WKND イネーブルメント web サイトでの実際のエクスペリエンスのパーソナライゼーション。 デモサイトでは、A/B テスト、行動ターゲティング、既知のユーザーによるパーソナライゼーションの 3 種類のパーソナライゼーションを示します。</p>
                </div>
