---
title: パーソナライズ機能の概要
description: Adobe TargetとAdobe Experience Platformのアプリケーションを使用して、AEM as a Cloud Serviceのweb サイトをパーソナライズする方法について説明します。
...
AEM as a Cloud Service（AEMCS）とAdobe TargetおよびAdobe Experience Platform（AEP）を統合して、パーソナライズされたエクスペリエンスを提供する方法について説明します。 エクスペリエンスフラグメントをパーソナライズされたコンテンツとして使用する方法、A/B テストの実施方法、リアルタイムの行動にもとづくユーザーのターゲティング方法、システムをまたいでデータから構築された統合顧客プロファイルを活用してコンテンツをパーソナライズする方法をご紹介します。

## 前提条件

様々なパーソナライゼーションシナリオを示すために、このチュートリアルではサンプル [AEM WKND](https://github.com/adobe/aem-guides-wknd/) プロジェクトを使用します。 フォローするには、次のものが必要です。

- 次のアクセス権を持つAdobe組織：
   - **AEM as a Cloud Service環境** - コンテンツの作成と管理
   - **Adobe Target** - パーソナライズされたエクスペリエンスを構成して配信する
   - **Adobe Experience Platform アプリケーション** – 顧客プロファイルとオーディエンスを管理する
   - AEP **の** タグ（以前のLaunch） – データ収集とパーソナライゼーションのためにWeb SDKとカスタム JavaScriptをデプロイする

- AEMのコンポーネントとエクスペリエンスフラグメントについて
...
>[!TIP]
>
> 最初にライブデモを探索することで、設定と実装に時間を費やす前に、各パーソナライゼーション手法の価値と機能を理解することができます。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./live-demo.md" title="Personalizationのユースケースのライブデモ" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/live-demo/live-demo.png" alt="Personalizationのユースケースのライブデモ"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./live-demo.md" target="_self" rel="referrer" title="Personalizationのユースケースのライブデモ">Personalizationの使用例のライブデモ </a>
                    </p>
                    <p class="is-size-6">WKND イネーブルメント web サイトでパーソナライゼーションを実際に体験します。 デモサイトでは、A/B テスト、行動ターゲティング、既知のユーザーに対するパーソナライゼーションの3種類のパーソナライゼーションが紹介されています。</p>
                </div>
                <a href="./live-demo.md" target="_self" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold"> ライブデモ </span>
                </a>
            </div>
        </div>
    </div>
...
具体的なユースケースを検討する前に、まずAEM as a Cloud Serviceをパーソナライズ用に設定します。 まず、Adobe TargetとTagsを統合し、Web SDKを使用してクライアントサイドのパーソナライズを可能にします。 これらの基本的なステップにより、AEMページはテスト、オーディエンスのターゲティング、リアルタイムのパーソナライゼーションをサポートできます。
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">AEMCとAdobe Targetを統合して、エクスペリエンスフラグメントなどのパーソナライズされたコンテンツをオファーとしてアクティベートします。</p>
                </div>
                <a href="./setup/integrate-adobe-target.md" target="_self" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Targetの統合</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">AEMCSとタグを統合して、データ収集とパーソナライズのためにWeb SDKとカスタム JavaScriptを挿入します。</p>
                </div>
...
AEMCS、Adobe Target、Adobe Experience Platformでサポートされている次の一般的なパーソナライゼーションのユースケースをご覧ください。
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Experimentation (A/B Testing)">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./use-cases/experimentation.md" title="A/B テストによる検証" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/use-cases/experiment/experimentation.png" alt="A/B テストによる検証"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./use-cases/experimentation.md" target="_self" rel="referrer" title="A/B テストによる検証">実験（A/B テスト） </a>
                    </p>
                    <p class="is-size-6">Adobe Targetを使用してA/B テストを行い、AEMCS web サイトで様々なコンテンツバリエーションをテストする方法について説明します。</p>
                </div>
                <a href="./use-cases/experimentation.md" target="_self" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">実験を学ぶ</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Adobe Experience PlatformとAdobe Targetを活用して、利用者の行動にもとづいてコンテンツをパーソナライズする方法を紹介します。</p>
                </div>
                <a href="./use-cases/behavioral-targeting.md" target="_self" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">行動ターゲティングの学習</span>
                </a>
            </div>
        </div>
    </div>
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Known-user personalization">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./use-cases/known-user-personalization.md" title="既知顧客のパーソナライゼーション" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="./assets/use-cases/known-user-personalization/known-user-personalization.png" alt="既知顧客のパーソナライゼーション"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="./use-cases/known-user-personalization.md" target="_self" rel="referrer" title="既知顧客のパーソナライゼーション">既知のユーザーのパーソナライゼーション </a>
                    </p>
                    <p class="is-size-6">複数のシステムからの情報をつなぎ合わせて包括的な顧客プロファイルを作成し、既知の顧客データにもとづいてコンテンツをパーソナライズする方法を紹介します。</p>
                </div>
                <a href="./use-cases/known-user-personalization.md" target="_self" rel="referrer" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
                    <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">既知のユーザーのパーソナライゼーションの学習</span>
                </a>
            </div>
        </div>
    </div>
