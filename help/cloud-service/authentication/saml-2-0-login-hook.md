...
SAML フックで、ユーザープロパティなどのAEM JCR リポジトリ内のコンテンツを変更する必要がある場合（`postSyncUserProcess` の例を参照）、[&#x200B; サービスユーザー &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/developing/advanced/service-users) を設定する必要があります。
