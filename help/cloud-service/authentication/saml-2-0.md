...
SAML フックでリポジトリ内のユーザープロパティを変更する必要がある場合（`postSyncUserProcess` の例に示すように）は、[&#x200B; サービスユーザー &#x200B;](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/developing/advanced/service-users) を設定する必要があります。
