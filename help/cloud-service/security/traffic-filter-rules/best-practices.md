...
AEM プロジェクトに対して、以下のトラフィックフィルタールールを有効にします。ただし、`rateLimit` プロパティと `clientCountry` プロパティに必要な値は、セキュリティ チームと協力して決定する必要があります。
...
AEM プロジェクトでは、以下の WAF ルールを検討します。ただし、`action` および `wafFlags` プロパティに必要な値は、セキュリティチームと協力して決定する必要があります。
