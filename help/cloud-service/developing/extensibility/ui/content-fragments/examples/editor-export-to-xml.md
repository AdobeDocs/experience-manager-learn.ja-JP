...
| AEM UI 拡張 | 拡張ポイント |
| ------------------------ | --------------------- | 
| [コンテンツフラグメントコンソール](https://developer.adobe.com/uix/docs/services/aem-cf-editor/) | [ヘッダーメニュー](https://developer.adobe.com/uix/docs/services/aem-cf-editor/api/header-menu/) |
