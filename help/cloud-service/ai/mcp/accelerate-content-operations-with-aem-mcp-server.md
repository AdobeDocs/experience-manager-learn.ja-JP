...
1. **AEM-RDE-Content-Read-Only} および** 2}AEM-RDE-Content} が接続済みとして表示され **ことを確認します。**&#x200B;各サーバーを展開して、そのツールを表示できます。
...
1. [WKND Site](https://github.com/adobe/aem-guides-wknd) プロジェクトを RDE にデプロイします。 詳しい手順については、[ 迅速な開発環境の使用方法 ](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/developing/rde/how-to-use#deploy-aem-artifacts-using-the-aem-rde-plugin) を参照してください。
