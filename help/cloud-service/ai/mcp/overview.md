...
すべてのAEM MCP サーバーは、`https://mcp.adobeaemcloud.com/adobe/mcp/` の下で利用できます。 詳しくは、[AEM as a Cloud Serviceでの MCP の使用 &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-manager-cloud-service/content/ai-in-aem/using-mcp-with-aem-as-a-cloud-service) を参照してください。
...
AEM MCP サーバーは、MCP 互換アプリケーションの定義済みセットで動作するように設計されています。 次のアプリケーションが正式にサポートされています。

- [&#x200B; 人間的クロード &#x200B;](https://claude.com/product/overview)
- [&#x200B; カーソル &#x200B;](https://www.cursor.com/)
- [OpenAI ChatGPT](https://chatgpt.com/)
- [Microsoft コパイロット スタジオ &#x200B;](https://www.microsoft.com/en-us/microsoft-365-copilot/microsoft-copilot-studio)

詳しくは、[&#x200B; 設定の概要 &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-manager-cloud-service/content/ai-in-aem/using-mcp-with-aem-as-a-cloud-service#setup-overview) を参照してください。
