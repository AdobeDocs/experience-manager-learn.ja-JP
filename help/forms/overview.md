...
Adobe Experience Manager（AEM）は、複雑なデジタルフォームの作成、管理、公開、および更新に特化した、使いやすいソリューションです。また、バックエンドプロセス、ビジネスルール、およびデータとの統合も実現されています。このユーザガイドには、AEM Formsの多くの機能に関するビデオとチュートリアルが含まれています
...
<tr>
  ...
  <td>
    ...
    <p>
    <em>AEMワークフローのステップとしてForm Data Modelのサービスを呼び出す</em>
    <p>
  </td>
</tr>
</table>
