...
LDAPを使用してAEMを設定するために必要な手順については、ここで [詳しく説明します。](https://helpx.adobe.com/experience-manager/6-5/sites/administering/using/ldap-config.html)
...
この記事を読んで、独自のParticipantChooserを実装してくだ [ さい。](https://helpx.adobe.com/jp/experience-manager/using/dynamic-steps.html)
