...
+ [aem-guides-wknd.all-2.1.0.zip以降](https://github.com/adobe/aem-guides-wknd/releases)
...
1. [最新のAEM SDKのダウンロード](https://experience.adobe.com/#/downloads/content/software-distribution/jp/aemcloud.html?fulltext=AEM*+SDK*&orderby=%40jcr%3Acontent%2Fjcr%3AlastModified&orderby.sort=desc&layout=list&p.offset=0&p.limit=1)
...
AEM SDKが開始され、[http://localhost:4502](http://localhost:4502)に自動的に起動します。 次の資格情報を使用してログインします。
...
1. [最新バージョンの`aem-guides-wknd.all.x.x.x.zip`をダウンロード](https://github.com/adobe/aem-guides-wknd/releases)
1. [http://localhost:4502/crx/packmgr](http://localhost:4502/crx/packmgr)のAEM SDK パッケージマネージャーに`admin`の資格情報でログインします。
...
1. [`wknd-app.all.x.x.x.zip`をダウンロード](./assets/quick-setup/wknd-app.all-1.0.0-SNAPSHOT.zip)
1. [`wknd-app.ui.content.sample.x.x.x.zip`をダウンロード](./assets/quick-setup/wknd-app.ui.content.sample-1.0.1.zip)
1. [http://localhost:4502/crx/packmgr](http://localhost:4502/crx/packmgr)のAEM SDK パッケージマネージャーに`admin`の資格情報でログインします。
