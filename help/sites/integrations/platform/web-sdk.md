---
title: Experience Platform Web SDK の統合
description: AEM as a Cloud Service と Experience Platform Web SDK を統合する方法を説明します。この基本的なステップは、Adobe Analytics、Target などの Adobe Experience Cloud 製品や、Real-time Customer Data Platform、Customer Journey Analytics、Journey Optimizer などの最近の革新的な製品を統合するために不可欠です。
...
# Experience Platform Web SDK の統合
