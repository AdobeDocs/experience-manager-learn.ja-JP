...
+ Edge Delivery Services{#edge-delivery-services}
   ...
   + 開発{#developing}
      ...
      + ユニバーサルエディター {#universal-editor}
         ...
         + [新しい AEM サイト](./edge-delivery-services/developing/universal-editor/2-new-aem-site.md)
         ...
         + [新しいブロック](./edge-delivery-services/developing/universal-editor/5-new-block.md)
         ...
         + 方法{#how-to}
            ...
            + [ローカル拡張機能のプレビュー](./edge-delivery-services/developing/universal-editor/how-to/local-extension-preview.md)
   + 方法{#how-to}
...
+ 開発 {#developing}
   ...
   + [AEM スタイルシステムによるコンテンツベロシティの促進](developing/accelerate-content-velocity-aem-style-system.md)
